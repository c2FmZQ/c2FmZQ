	...
	app := &cli.App{
		...
		Flags: []cli.Flag{
			...
			&cli.StringFlag{
				...
				EnvVars:     []string{"C2FMZQ_PATH_PREFIX"},
			...
			&cli.StringFlag{
				...
				EnvVars:     []string{"C2FMZQ_BASE_URL"},
			...
			&cli.StringFlag{
				...
				EnvVars:     []string{"C2FMZQ_REDIRECT_404"},
			...
			&cli.StringFlag{
				...
				EnvVars:     []string{"C2FMZQ_AUTOCERT_ADDRESS"},
			...
			&cli.BoolFlag{
				...
				EnvVars:     []string{"C2FMZQ_ALLOW_NEW_ACCOUNTS"},
			...
			&cli.BoolFlag{
				...
				EnvVars:     []string{"C2FMZQ_AUTO_APPROVE_NEW_ACCOUNTS"},
			...
			&cli.IntFlag{
				...
				EnvVars:     []string{"C2FMZQ_MAX_CONCURRENT_REQUESTS"},
